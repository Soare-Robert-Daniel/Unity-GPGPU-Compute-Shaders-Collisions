...
public class GPUCollisionsV2 : MonoBehaviour
{
    ...
    public void InitObjects()
    {
        ...
        // Add triangle vertices in triangleVertices array
    ...
    private const int TRIANGLE_MODEL_SIMPLE_STRIDE = sizeof(float) * (3) + sizeof(int) * 3;
    ...
    {
        objectsBuffer.GetData(objectsInfo);
    }
